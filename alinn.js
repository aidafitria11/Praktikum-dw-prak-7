document.addEventListener("DOMContentLoaded", function () {
    ...
    function tampilkanSalam(nama) {
        salamPenggunaEl.textContent = `Halo, ${nama}! Selamat datang di perpustakaan.`;
    }
    ...
    function tampilkanDaftarBuku() {
        ...
        daftarBuku.forEach((buku, index) => {
            ...
            bukuEl.innerHTML = `
                ...
                <button class="bg-pink-500 text-white px-4 py-2 mt-2 rounded-lg hover:bg-pink-600" onclick="tambahKeFavorit(${index})">Tambahkan ke Favorit</button>
            `;
